...
Usage
=====
Maybe images in github do not fit with the Odoo apps, so you can check: https://apps.odoo.com/apps/modules/11.0/web_login/ for more details.
Thank you.
...
.. note::  Remmember that, install *web_login* **after** install module *website*. Or please **upgrade** *web_login* after install module *website*
